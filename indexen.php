...
<head>
    ...
    <meta name="description" lang="en"
          content="Oriole Ltd web studio provides services for the development of Web sites, promo-sites, corporate websites, online stores and web applications"/>
...
<a href="index"> <img src="image/Blank.png" class="flag flag-ru"/> </a>
...
<div class="third">
    <div class="container">
        ...
        <p>Oriole is an Eastern European web studio located in Kharkiv, Ukraine. We are future-oriented company which
            provide quality web solutions in nowadays competitive and changing environment. Strong reference, wide
            exceptional approach, transparent workflow and superior quality make you feel the benefits of working with
            us. That is why you can have peace of mind about technology and focus on your core business, because we aim
        ...
        <div class="technology">
            ...
            <table>
                ...
                <td>
                    <svg viewBox="0 0 128 128">
                        <path fill="#0074BD"
                              d="M52.581 67.817s-3.284 1.911 2.341 2.557c6.814.778 10.297.666 17.805-.753 0 0 1.979 1.237 4.735 2.309-16.836 7.213-38.104-.418-24.881-4.113zM50.522 58.402s-3.684 2.729 1.945 3.311c7.28.751 13.027.813 22.979-1.103 0 0 1.373 1.396 3.536 2.157-20.352 5.954-43.021.469-28.46-4.365z"></path>
                        <path fill="#EA2D2E"
